 ...
 * @version 1.0
 */
public class frmSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setName("frmSuccess"); // NOI18N
        setUndecorated(true);
        setResizable(false);

        pn_logo.setBackground(new java.awt.Color(0, 153, 0));
        ...
        lb_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Success 110px.png"))); // NOI18N
        ...
        lb_title.setForeground(new java.awt.Color(0, 153, 0));
        lb_title.setText("COMPLETADO!");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(frmSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSuccess(null).setVisible(true);
            }
        });
    }
