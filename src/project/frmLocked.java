 ...
 * @version 1.0
 */
public class frmLocked extends javax.swing.JFrame {

    public frmLocked(String message) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lb_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/LockedBig.png"))); // NOI18N
        ...
        lb_title.setText("PLACA BLOQUEADA");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(frmLocked.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmLocked(null).setVisible(true);
            }
        });
    }
